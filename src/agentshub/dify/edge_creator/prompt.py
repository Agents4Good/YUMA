EDGE_CREATOR = """
    ...
    1. `create_edges(edge_id: str, source_id: str, source_type: str, target_id: str, target_type: str)`
    2. `create_logic_edges(edge_id: str, source_id: str, source_handle: Literal["true", "false"], target_id: str, source_type: str, target_type: str)`
