NODE_CREATOR = """
    ...
    3. `create_agent_node(title: str, node_id: str, instruction: str, context_variable: str, tool: Literal["web_scraper"], temperature: float)` - Cria um nó de agente ReAct que utiliza tools para um workflow multiagente.
